...
artifacts_dir="apache-arrow-dotnet-${version}-rc${rc}"
...
Subject: [VOTE][.NET] Release Apache Arrow .NET ${version} RC${rc}

Hi,

I would like to propose the following release candidate (RC${rc}) of
Apache Arrow .NET version ${version}.
...
[ ] +1 Release this as Apache Arrow .NET ${version}
[ ] +0
[ ] -1 Do not release this as Apache Arrow .NET ${version} because...

[1]: https://github.com/apache/arrow-dotnet/tree/${rc_hash}
[2]: https://github.com/apache/arrow-dotnet/releases/${rc_tag}
[3]: https://github.com/apache/arrow-dotnet/blob/main/dev/release/README.md#verify
MAIL
echo "---------------------------------------------------------"
