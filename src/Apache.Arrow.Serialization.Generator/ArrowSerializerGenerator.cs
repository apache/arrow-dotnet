        ...
        private static TypeModel? GetTypeModel(GeneratorAttributeSyntaxContext ctx)
        {
            ...
            foreach (var member in typeSymbol.GetMembers())
            {
                ...
                if (converterTypeName != null)
                    typeInfo = new TypeInfo { Kind = ArrowTypeKind.Custom, FullTypeName = typeInfo.FullTypeName, IsNullable = isNullable };
            ...
            foreach (var p in properties)
            {
                if (p.Type.Kind == ArrowTypeKind.Unknown)
        ...
        private static TypeInfo AnalyzeType(ITypeSymbol type, bool isNullable)
        {
            ...
            foreach (var attr in type.GetAttributes())
            {
                if (attr.AttributeClass?.ToDisplayString() == "Apache.Arrow.Serialization.ArrowSerializableAttribute")
                {
                    return new TypeInfo
                    {
                        Kind = ArrowTypeKind.NestedRecord,
                        FullTypeName = fullName,
                        IsNullable = isNullable,
                    };
                }
            ...
            {
                "string" => ArrowTypeKind.String,
                "bool" => ArrowTypeKind.Bool,
                "byte" => ArrowTypeKind.Byte,
                "sbyte" => ArrowTypeKind.SByte,
                "short" => ArrowTypeKind.Int16,
                "ushort" => ArrowTypeKind.UInt16,
                "int" => ArrowTypeKind.Int32,
                "uint" => ArrowTypeKind.UInt32,
                "long" => ArrowTypeKind.Int64,
                "ulong" => ArrowTypeKind.UInt64,
                "float" => ArrowTypeKind.Float,
                "double" => ArrowTypeKind.Double,
                "decimal" => ArrowTypeKind.Decimal,
                "byte[]" => ArrowTypeKind.Binary,
                "System.ReadOnlyMemory<byte>" => ArrowTypeKind.Binary,
                "global::System.ReadOnlyMemory<byte>" => ArrowTypeKind.Binary,
                "System.DateTime" => ArrowTypeKind.DateTime,
                "global::System.DateTime" => ArrowTypeKind.DateTime,
                "System.DateTimeOffset" => ArrowTypeKind.DateTimeOffset,
                "global::System.DateTimeOffset" => ArrowTypeKind.DateTimeOffset,
                "System.DateOnly" => ArrowTypeKind.DateOnly,
                "global::System.DateOnly" => ArrowTypeKind.DateOnly,
                "System.TimeOnly" => ArrowTypeKind.TimeOnly,
                "global::System.TimeOnly" => ArrowTypeKind.TimeOnly,
                "System.TimeSpan" => ArrowTypeKind.TimeSpan,
                "global::System.TimeSpan" => ArrowTypeKind.TimeSpan,
                "System.Guid" => ArrowTypeKind.Guid,
                "global::System.Guid" => ArrowTypeKind.Guid,
                "System.Half" => ArrowTypeKind.Half,
                "global::System.Half" => ArrowTypeKind.Half,
                _ => ArrowTypeKind.Unknown,
            };
